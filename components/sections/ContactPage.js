                    ...
                    <div className="row align-items-center justify-content-between">
                        <div className="col-lg-6">
                            <div className="contact-content-part rmb-55 wow fadeInRight delay-0-2s">
                                <div className="section-title mb-60">
                                    <span className="sub-title mb-15">Trusted web design services</span>
                                ...
                                <form action="#" method="post">
                                    ...
                                    <button type="submit" className="theme-btn"><i className="fal fa-paper-plane" /> Get In Touch</button>
                                </form>
                            </div>
                        </div>
                        <div className="col-xl-5 col-lg-6">
                            <div className="contact-info-part wow fadeInLeft delay-0-2s">
                                <h3>Get in touch</h3>
                                <p>Lorem ipsum dolor sit amet consectetur adipi scing elit mattis faucibus odio feugiat arc</p>
                                <div className="row">
