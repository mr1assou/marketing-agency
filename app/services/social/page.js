    ...
    return (
        <>
            ...
            <Layout headerStyle={1} footerStyle={1}>
                ...
                <section className="py-120 rpy-80 social-hero" style={{ minHeight: '100vh' }}>
                    <div className="container">
                        <div className="row align-items-center">
                            <div className="col-lg-7">
                                <h1 className="mb-15">Social Media Marketing</h1>
                                <p className="mb-20">Build awareness and community with channel‑specific strategies across Meta, LinkedIn, TikTok, and more. We create content that resonates and converts.</p>
                                <ul className="list-style-two mb-25">
                                    <li>Channel strategy and content calendars</li>
                                    <li>Creative production and community management</li>
                                    <li>Paid social audience and creative testing</li>
                                    <li>Reporting and insights to guide growth</li>
                                </ul>
                                <Link href="/contact" className="theme-btn style-two">Plan Your Campaign</Link>
                            </div>
                            <div className="col-lg-5">
                                <div className="rounded overflow-hidden">
                                    <Image src="/assets/images/hero/social.jpg" alt="Social Media Service" width={1200} height={800} style={{ width: '100%', height: 'auto' }} />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section className="py-120 rpy-80 social-prod">
                    <div className="container">
                        <div className="row align-items-center">
                            <div className="col-lg-7">
                                <h1 className="mb-15">Paid Social Campaigns</h1>
                                <p className="mb-20">Scale reach and conversions with data‑driven targeting and ongoing creative testing across paid social platforms.</p>
                                <ul className="list-style-two mb-25">
                                    <li>Pixel setup and conversion tracking</li>
                                    <li>Audience segmentation and lookalikes</li>
                                    <li>Creative iteration and message testing</li>
                                    <li>Budget pacing and clear reporting</li>
                                </ul>
                                <Link href="/contact" className="theme-btn style-two">Launch Paid Social</Link>
                            </div>
                            <div className="col-lg-5">
                                <div className="rounded overflow-hidden">
                                    <Image src="/assets/images/hero/paid.jpg" alt="Paid Social" width={1200} height={800} style={{ width: '100%', height: 'auto' }} />
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="row">
                            <div className="col-lg-4 col-md-6">
                                <div className="counter-item style-two counter-text-wrap wow fadeInUp delay-0-2s">
                                    <CounterUp count={10} time={3} kPlus />
                                    <h6 className="counter-title">Posts & creatives shipped</h6>
                                </div>
                            </div>
                            <div className="col-lg-4 col-md-6">
                                <div className="counter-item style-two counter-text-wrap wow fadeInUp delay-0-4s">
                                    <CounterUp count={250} time={3} plus />
                                    <h6 className="counter-title">Communities managed</h6>
                                </div>
                            </div>
                            <div className="col-lg-4 col-md-6">
                                <div className="counter-item style-two counter-text-wrap wow fadeInUp delay-0-6s">
                                    <CounterUp count={35} time={3} kPlus />
                                    <h6 className="counter-title">Monthly engagements</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="container">
                        <div className="row gap-50">
                            <div className="col-lg-6 col-md-6">
                                <Link href="/services/social" className="feature-item wow fadeInUp delay-0-2s">
                            ...
                            <div className="col-lg-6 col-md-6">
                                <Link href="/services/seo" className="feature-item wow fadeInUp delay-0-4s">
