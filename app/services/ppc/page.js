    ...
    return (
        <>
            ...
            <Layout headerStyle={1} footerStyle={1}>
                ...
                <section className="py-120 rpy-80 ppc-hero" style={{ minHeight: '100vh' }}>
                        ...
                        <div className="row align-items-center">
                            ...
                            <div className="col-lg-5">
                                <div className="ppc-visual">
                                    <Image src="/assets/images/hero/ppc.jpg" alt="SEO Service" width={1200} height={800} style={{ width: '100%', height: 'auto' }} />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section className="py-120 rpy-80 ppc-prod">
                    <div className="container">
                        <div className="row align-items-center">
                            <div className="col-lg-7">
                                <h1 className="mb-15">PPC Advertising</h1>
                                <p className="mb-20">Drive qualified traffic with high‑intent search and targeted display campaigns. We optimize bids, audiences, and creative to maximize ROI.</p>
                                <ul className="list-style-two mb-25">
                                    <li>Account structure & conversion tracking</li>
                                    <li>Keyword, audience, and creative testing</li>
                                    <li>Landing page recommendations</li>
                                    <li>Continuous optimization & transparent reporting</li>
                                </ul>
                                <Link href="/contact" className="theme-btn style-two">Get a PPC Strategy</Link>
                            </div>
                            <div className="col-lg-5">
                                <div className="ppc-visual">
                                    <Image src="/assets/images/hero/fb.jpg" alt="PPC Service" width={1200} height={800} style={{ width: '100%', height: 'auto' }} />
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <style jsx>{`
                    .ppc-hero h1 { font-size: clamp(28px, 6vw, 64px); line-height: 1.15; }
                    .ppc-visual { position: relative; border-radius: 16px; overflow: hidden; box-shadow: 0 20px 50px rgba(0,0,0,0.25); }
                    .ppc-visual img { width: 100%; height: auto; display: block; }
                    @media (min-width: 992px) { .ppc-visual { transform: scale(1.06); } }
                    @media (max-width: 991px) {
                        .ppc-hero h1, .ppc-prod h1 { font-size: 32px; line-height: 1.25; }
                        .ppc-visual { transform: none; margin-top: 20px; }
                        .ppc-hero .list-style-two, .ppc-prod .list-style-two { margin-bottom: 16px; }
                        .ppc-hero .theme-btn, .ppc-prod .theme-btn { width: 100%; text-align: center; }
                    }
                    ...
                    <div className="container">
                        <div className="row gap-50">
                            <div className="col-lg-6 col-md-6">
                                <Link href="/services/ppc" className="feature-item wow fadeInUp delay-0-2s">
